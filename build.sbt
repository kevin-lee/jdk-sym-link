...
lazy val props =
  new {
    ...
    final val effectieVersion  = "2.5.0"
    final val refined4sVersion = "1.21.0"
    ...
    final val ExtrasVersion = "0.56.0"

    final val JustSemVerVersion = "1.3.0"

    final val hedgehogVersion = "0.14.0"
